...
<Tabs>
  ...
  <TabItem label='Schriftschnitte'>
    <Steps>
      ...
      5. Wähle im Bereich **Import** die Schriftschnitte aus, die du verwenden möchtest. In unserem Fall entscheiden wir uns für <Badge text="400" variant="note" /> und <Badge text="700" variant="note" />. Kopiere nun den Code und füge ihn in der `app.js` oben ein:
