...
<Tabs>
  <TabItem label="macOS">
    <Steps>
      ...
      4. Wechsle zurück zur Kommandozeile, gebe `cd` ein und füge den Pfad mit <kbd>⌘ Command</kbd> + <kbd>V</kbd> ein.
  ...
  <TabItem label="Windows">
    <Steps>
      ...
      4. Wechsle zurück zur Kommandozeile, gebe `cd` ein und füge den Pfad mit <kbd>Strg</kbd> + <kbd>V</kbd> ein.
...
Wenn du den aktuellen Pfad in Visual Studio Code öffnen möchtest, kannst du das auch direkt aus der Kommandozeile heraus tun. Gebe dazu einfach `code` und den Pfad ein:
