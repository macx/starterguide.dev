...
<Lead>
  Package Manager helfen uns dabei, eine Entwicklungs&#xAD;umgebung
  bereitzustellen. So installierst du sie.
</Lead>
...
Package Manager werden über das Terminal verwendet. Bei Windows heißt das Terminal PowerShell. Wenn du noch nie mit dem Terminal gearbeitet hast, lies dir unbedingt die [Einführung](/guides/terminal) durch.

Wenn du einzig mit dem Website-Starterkit arbeiten möchtest, reicht die einfache Installation von Node.js. Möchtest du jedoch tiefer in die Webentwicklung einsteigen, empfehlen wir dir, auch Corepack und Git zu installieren.

:::note
Die folgenden Schritte musst du nur einmalig auf deinem Computer durchführen. Wenn du die Tools bereits installiert hast, kannst du direkt das [Starterkit](/starterkit/intro) nutzen.
:::
...
<Tabs>
  <TabItem label="macOS">
  Die einfachste Möglichkeit, Node.js für macOS zu installieren, ist über [Homebrew](/guides/homebrew-chocolatey), einem Paketmanager für macOS. Wenn du den eingerichtet hast, führe zur Installation von Node.js folgenden Befehl im Terminal aus:
