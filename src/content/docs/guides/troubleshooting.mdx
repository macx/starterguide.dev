...
Falls auch im normalen Terminal kein Pfad gefunden wird, musst du Python installieren. Am einfachsten geht das über [Homebrew](/guides/homebrew-chocolatey) mit `brew install python` oder indem du die **Command Line Tools** (siehe oben) installierst.
